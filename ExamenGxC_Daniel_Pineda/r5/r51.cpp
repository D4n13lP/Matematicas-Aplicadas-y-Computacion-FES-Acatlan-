...
static void drawDodecaedro(bool wire)
{
    ...
    const float a=sc*1.0f, b=sc/phi, c=sc*phi;
    ...
    // 12 pentagonos (indices)
    int fi[12][5] = {
        { 0,8,10, 2,16},{ 0,12, 1,17,16},{ 1,12,14, 5, 9},
        { 2,10, 6,15,13},{ 3,11, 9, 5,19},{ 3,13,15, 7,11},
        { 4,14,12, 0, 8},{ 4, 8,10, 6,18},{ 5,14, 4,18,19},
        { 6,10, 2,13,15},{ 7,15, 6,18,19},{ 1, 9,11, 3,17}
    };
    ...
    for (int i = 0; i < 12; i++) {
        ...
        // Dibuja como abanico de triangulos desde p0
        for (int k = 1; k < 4; k++) {
            glBegin(wire ? GL_LINE_LOOP : GL_TRIANGLES);
              glVertex3fv(p0);
